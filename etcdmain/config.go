...
func newConfig() *config {
	...
	fs.Float64Var(&cfg.ec.RequestsPerSecondLimit, "experimental-requests-per-second-limit", cfg.ec.RequestsPerSecondLimit, "Sets the maximum revisions deleted in each compaction batch.")
